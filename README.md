...
| [`template`]() [![image](https://github.com/kamangir/assets/raw/main/blue-plugin/marquee.png?raw=true)]()  |  |  |
...
built by 🌀 [`blue_options-4.229.1`](https://github.com/kamangir/awesome-bash-cli), based on 🌐 [`blue_geo-4.1078.1`](https://github.com/kamangir/blue-geo).
