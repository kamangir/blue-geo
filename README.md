...
built by 🪄 [`abcli-9.244.1-current`](https://github.com/kamangir/awesome-bash-cli), based on 🌐 [`blue_geo-4.230.1`](https://github.com/kamangir/blue-geo).
