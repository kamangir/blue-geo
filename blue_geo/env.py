...
MAXAR_OPEN_DATA_CLIENT_QUERY_RADIUS_str = os.getenv(
    "MAXAR_OPEN_DATA_CLIENT_QUERY_RADIUS", ""
)
try:
    MAXAR_OPEN_DATA_CLIENT_QUERY_RADIUS = float(MAXAR_OPEN_DATA_CLIENT_QUERY_RADIUS_str)
except Exception:
    MAXAR_OPEN_DATA_CLIENT_QUERY_RADIUS = 0.01

MAXAR_OPEN_DATA_CLIENT_CACHE_ITEMS_str = os.getenv(
    "MAXAR_OPEN_DATA_CLIENT_CACHE_ITEMS",
    "",
)
MAXAR_OPEN_DATA_CLIENT_CACHE_ITEMS = MAXAR_OPEN_DATA_CLIENT_CACHE_ITEMS_str == "1"

BLUE_GEO_PALISADES_TEST_DATACUBE = os.getenv(
    "BLUE_GEO_PALISADES_TEST_DATACUBE",
    "",
)

BLUE_GEO_TEST_QUERY_OBJECT_PALISADES_MAXAR_TEST = os.getenv(
